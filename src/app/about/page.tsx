      ...
      <section className="container mx-auto px-4">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Từ năm 2010, Đồ Cũ Thiên Tiến đã là cầu nối uy tín giữa người cần thanh lý và người tìm kiếm sản phẩm chất lượng với giá phải chăng. Chúng tôi tin rằng mọi món đồ cũ đều có giá trị và xứng đáng có một cuộc đời mới.
          </p>
        </div>
      </section>
