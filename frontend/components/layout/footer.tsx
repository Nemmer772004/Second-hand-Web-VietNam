    ...
    <footer className="bg-card text-card-foreground border-t">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="font-headline text-2xl font-bold">Đồ Cũ Bảo Anh</span>
            </Link>
            ...
            <p className="text-muted-foreground">Email: haitien2709@gmail.com</p>
            <div className="mt-4">
              <iframe
        ...
        <div className="mt-12 border-t pt-8 flex flex-col sm:flex-row justify-between items-center gap-4">
          <p className="text-sm text-muted-foreground">&copy; {new Date().getFullYear()} Đồ Cũ Bảo Anh. Bảo lưu mọi quyền.</p>
